...
public class SimSO {
    ...
    public static void testarMemoria() {
        ...
        Job job1 = new Job(5, 0, 1, 1, "Job1", v1, depen1);
        Job job2 = new Job(7, 0, 0, 0, "Job2", v2, depen2);
        Job job3 = new Job(7, 0, 0, 1, "Job3", v3, depen3);
        Job job4 = new Job(8, 0, 0, 1, "Job1", v1, depen1);
        Job job5 = new Job(10, 0, 0, 0, "Job2", v2, depen2);
        Job job6 = new Job(4, 0, 0, 3, "Job3", v3, depen3);
        Job job7 = new Job(3, 0, 0, 4, "Job1", v1, depen1);
        Job job8 = new Job(12, 0, 0, 1, "Job2", v2, depen2);
    ...
    public static void testarWaitingQueue() {
        ...
        Job job1 = new Job(5, 0, 1, 1, "Job1", v1, depen1);
        Job job2 = new Job(7, 0, 0, 0, "Job2", v2, depen2);
        Job job3 = new Job(7, 0, 2, 1, "Job3", v3, depen3);
        Job job4 = new Job(8, 0, 0, 1, "Job1", v1, depen1);
        Job job5 = new Job(10, 0, 0, 0, "Job2", v2, depen2);
        Job job6 = new Job(4, 0, 0, 3, "Job3", v3, depen3);
        Job job7 = new Job(3, 0, 0, 4, "Job1", v1, depen1);
